...
//    val logic = new MailerLogic(sesMock, dynamoMock, s3Mock, "lambda-mailer-test-LambdaMailerTable-546XVS89ZIJC", "lambda-mailer-test-mailerattachments-13imtk11twvod", true)
//
//    // Act
